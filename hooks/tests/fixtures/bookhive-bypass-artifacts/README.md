# bookhive-bypass-artifacts

Verbatim, byte-for-byte copies of the artifacts produced by the BookHive
...
| File | Source path in bookhive-e2e | Used by |
|---|---|---|
...
## Cross-reference: bookhive-e2e bypass commit
