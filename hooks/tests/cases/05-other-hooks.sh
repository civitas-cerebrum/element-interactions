...
SKIP_OK='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout, surface subset of j-create probed in pass 4 app-wide CSRF","criteria":["priority-p3","page-subset-covered","zero-prior-findings","low-surface-shape"]}],"updatedAt":"2026-05-06T00:00:00Z"}'
