...
# adversarialSkippedJourneys[] validation (issue #164.4)
SKIP_OK='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout, surface subset of j-create probed in pass 4 portal-wide CSRF","criteria":["priority-p3","page-subset-covered","zero-prior-findings","low-surface-shape"]}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_allow "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_OK")" "adversarialSkippedJourneys[] with rationale → ALLOW"
SKIP_NOT_ARR='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":"j-zb-logout","updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_NOT_ARR")" "adversarialSkippedJourneys not an array → DENY" "must be an array"
SKIP_EMPTY_RAT='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-x","rationale":""}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_EMPTY_RAT")" "adversarialSkippedJourneys entry with empty rationale → DENY" "missing required fields"
SKIP_NO_RAT='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-x"}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_NO_RAT")" "adversarialSkippedJourneys entry without rationale → DENY" "missing required fields"
SKIP_NO_JOURNEY='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"rationale":"x"}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_NO_JOURNEY")" "adversarialSkippedJourneys entry without journey → DENY" "missing required fields"
SKIP_EMPTY='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_allow "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_EMPTY")" "adversarialSkippedJourneys empty array → ALLOW"
# Important regression: the new dispatch-detection regex (issue #164.4) excludes adversarialSkippedJourneys[] entries from the dispatch count.
SKIP_ONLY='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout"}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_ONLY")" "adversarialSkippedJourneys without dispatches → DENY (skip entries don't count as dispatches)" "zero dispatches recorded"
# criteria array validation (PR #175 review): MUST be an array containing all four canonical strings.
SKIP_NO_CRIT='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout, surface subset"}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_NO_CRIT")" "adversarialSkippedJourneys entry without criteria field → DENY" "criteria"
SKIP_EMPTY_CRIT='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout, surface subset","criteria":[]}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_EMPTY_CRIT")" "adversarialSkippedJourneys entry with empty criteria → DENY" "criteria"
SKIP_THREE_CRIT='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout, surface subset","criteria":["priority-p3","page-subset-covered","zero-prior-findings"]}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_THREE_CRIT")" "adversarialSkippedJourneys entry with only 3 of 4 criteria → DENY" "criteria"
SKIP_EXTRA_CRIT='{"status":"in-progress","mode":"depth","currentPass":1,"journeyRoster":["j-a"],"passes":{"1-compositional":{"dispatches":[{"journey":"j-a","stage_a_cycles":1,"stage_b_cycles":1,"review_status":"greenlight"}]}},"adversarialSkippedJourneys":[{"journey":"j-zb-logout","rationale":"P3 logout, surface subset","criteria":["priority-p3","page-subset-covered","zero-prior-findings","low-surface-shape","extra-non-canonical"]}],"updatedAt":"2026-05-06T00:00:00Z"}'
assert_deny "$H" "$(payload tool_name=Write file_path='/x/tests/e2e/docs/coverage-expansion-state.json' content="$SKIP_EXTRA_CRIT")" "adversarialSkippedJourneys entry with extra non-canonical criterion → DENY" "criteria"
