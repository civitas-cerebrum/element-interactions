...
ALLOWED_PREFIX_REGEX='^(phase1-[a-z0-9-]+|phase2-[a-z0-9-]+|phase4-cycle-[0-9]+-section-[a-z0-9-]+|phase4-prioritise-author[a-z0-9-]*|stage2-[a-z0-9-]+|composer-[a-z0-9-]+|reviewer-[a-z0-9-]+|probe-[a-z0-9-]+|cleanup-[a-z0-9-]+|process-validator-[a-z0-9-]+|phase-validator-[a-z0-9-]+)(:|[[:space:]]|$)'
