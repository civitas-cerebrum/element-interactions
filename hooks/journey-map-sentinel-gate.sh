...
# Canonical reference
# -------------------
# skills/journey-mapping/SKILL.md §"Recognizing a previously-generated
#                                   journey map"
...
See: skills/journey-mapping/SKILL.md §\"Recognizing a previously-generated journey map\""
  fi
  exit 0
fi
...
See: skills/journey-mapping/SKILL.md §\"Cycle protocol\""
fi
