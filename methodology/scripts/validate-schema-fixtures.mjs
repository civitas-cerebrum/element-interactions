...
// For each methodology/schemas/subagent-returns/<role>.schema.json, verifies that
// fixtures/<role>-valid.yaml passes and fixtures/<role>-invalid.yaml
// fails. Also validates the methodology/schemas/onboarding-status.schema.json fixtures
// under methodology/schemas/onboarding-status.fixtures/ (every valid-*.json must
...
const dir = 'methodology/schemas/subagent-returns';
...
//   methodology/schemas/onboarding-status.fixtures/valid-*.json   must validate
//   methodology/schemas/onboarding-status.fixtures/invalid-*.json must fail
const onboardingSchemaPath = 'methodology/schemas/onboarding-status.schema.json';
const onboardingFixturesDir = 'methodology/schemas/onboarding-status.fixtures';
