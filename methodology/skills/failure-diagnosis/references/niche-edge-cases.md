...
The full criteria + ship path is also documented in `methodology/skills/contributing-to-element-interactions/SKILL.md` §"Contributing to the niche-edge-cases catalogue".
