...
Example skeleton (`methodology/scripts/render-catalogue-pdf.js`):
...
This skill is registered in `methodology/skills/element-interactions/references/skill-registry.md`:
