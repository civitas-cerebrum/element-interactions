...
assert_allow "$H" "$(payload tool_name=Agent description='composer-j-cart-1-c1' prompt='Compose. Return per methodology/schemas/subagent-returns/composer.schema.json.')" "composer + full path → ALLOW"
