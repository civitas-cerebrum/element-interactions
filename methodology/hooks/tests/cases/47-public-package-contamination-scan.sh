...
#
# Sourced by methodology/hooks/tests/run.sh — use the suite's section / counter
...
EXCLUDED_PATHS='methodology/hooks/tests/fixtures/bypass-artifacts|methodology/hooks/tests/cases/47-public-package-contamination-scan\.sh'
