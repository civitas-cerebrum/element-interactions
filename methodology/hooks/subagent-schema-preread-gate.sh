...
# full path "methodology/schemas/subagent-returns/<role>.schema.json" also satisfies
...
# Canonical reference
# -------------------
# methodology/schemas/subagent-returns/*.schema.json
# methodology/skills/element-interactions/references/subagent-return-schema.md
#
# Failure → action
# ----------------
...
SCHEMA_PATH="methodology/schemas/subagent-returns/${SCHEMA_FILENAME}"
