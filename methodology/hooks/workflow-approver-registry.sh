...
#
# Pairs with:
#   methodology/hooks/onboarding-ledger-gate.sh           (PreToolUse:Agent DENY — dispatch ordering)
#   methodology/hooks/onboarding-ledger-write-gate.sh     (PreToolUse:Write|Edit DENY — shape + actor identity)
