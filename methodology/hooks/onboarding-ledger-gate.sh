...
# Canonical reference
# -------------------
# methodology/schemas/onboarding-status.schema.json     — ledger shape
# methodology/schemas/subagent-returns/workflow-reviewer.schema.json — reviewer return
...
and the canonical exit criteria from methodology/skills/onboarding/SKILL.md §\"Phase
${LAST_DONE_PHASE}\".
...
methodology/skills/coverage-expansion/SKILL.md §\"Per-pass completion criteria\".

See:
  - methodology/skills/coverage-expansion/SKILL.md §\"Authoritative state file\"
  - methodology/skills/workflow-reviewer/SKILL.md
  - methodology/schemas/onboarding-status.schema.json"
      exit 0
    fi
...
See:
  - methodology/skills/journey-mapping/SKILL.md
  - methodology/skills/workflow-reviewer/SKILL.md
  - methodology/schemas/onboarding-status.schema.json"
      exit 0
    fi
