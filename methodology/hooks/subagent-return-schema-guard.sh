...
# methodology/schemas/subagent-returns/<role>.schema.json using Ajv 8 (draft 2020-12).
...
#
# Schema coverage:
#   composer-<slug>       → methodology/schemas/subagent-returns/composer.schema.json
#   reviewer-<slug>       → methodology/schemas/subagent-returns/reviewer-inloop.schema.json
#   probe-<slug>          → methodology/schemas/subagent-returns/probe.schema.json
#   phase-validator-<N>   → methodology/schemas/subagent-returns/phase-validator.schema.json
#
...
# Canonical reference
# -------------------
# methodology/schemas/subagent-returns/*.schema.json  — single source of truth
# methodology/skills/element-interactions/references/subagent-return-schema.md §4.2
#
# Failure → action
# ----------------
...
Schema validation errors (methodology/schemas/subagent-returns/${SCHEMA_ROLE}.schema.json):
${SCHEMA_ERRORS}"
fi
...
The canonical return schemas are at:
  methodology/schemas/subagent-returns/<role>.schema.json
