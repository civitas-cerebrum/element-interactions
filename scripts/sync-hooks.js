#!/usr/bin/env node
// sync-hooks.js — dev convenience: copy this repo's hooks/ into the user's
// ~/.claude/hooks/ and register them in ~/.claude/settings.json.
//
// Why this exists
// ---------------
// scripts/postinstall.js short-circuits when run from the package's own
...
// and skills are picked up by Claude Code from this repo's skills/ dir
// without a copy step.)
