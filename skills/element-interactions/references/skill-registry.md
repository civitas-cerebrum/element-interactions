...
| `<!-- portal-wide-scan:generated -->` | Sentinel on line 1 of `tests/e2e/docs/portal-wide-patterns.md`; confirms the file is the canonical Pass-4-prelude scan output and serves as the resume signal (per `coverage-expansion/references/portal-wide-scan.md` Hard constraint #1). | First line of `tests/e2e/docs/portal-wide-patterns.md`. |
