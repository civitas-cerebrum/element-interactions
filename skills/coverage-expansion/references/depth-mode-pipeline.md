...
Model selection per dispatch type — see [`coverage-expansion/SKILL.md`](../SKILL.md) §"Hybrid model selection — Sonnet by default, Opus where it pays" for the canonical table. The kernel rule supersedes any prior cost-blind / opus-default framing.
