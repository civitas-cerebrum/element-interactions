...
| Pass-4 prelude (portal-wide scan) | `docs(portal-wide): pattern catalogue established (pre-pass-4)` | Single commit at the start of Pass 4, before any per-journey probe is dispatched. Commit diff is `tests/e2e/docs/portal-wide-patterns.md` only. |
