...
Conforms to [`schemas/subagent-returns/workflow-reviewer.schema.json`](../../schemas/subagent-returns/workflow-reviewer.schema.json).
...
checklist:
  - item: One spec per primary journey passing locally
    ...
    methodology-ref: skills/onboarding/SKILL.md §"Phase 3"
